...
class ReportPatient(QDialog):
    ...
    def initButton(self):
        self.b_pre_save = self.ui.findChild(QPushButton, "save_pre_Button")
        self.b_pre_cancel = self.ui.findChild(QPushButton, "cancel_pre_Button")
    ...
    def getPostData(self,ui):
        ...
        self.post1_info.append(self.post1List[0][3].currentText())
        ...
        self.post2_info.append(self.post2List[0][3].currentText())
        ...
        self.post3_info.append(self.post3List[0][3].currentText())
        ...
        self.post4_info.append(self.post4List[0][3].currentText())
        ...
        self.post5_info.append(self.post5List[0][3].currentText())
        ...
        self.post6_info.append(self.post6List[0][3].currentText())
        ...
        self.post7_info.append(self.post7List[0][3].currentText())
    ...
    def save_post_info (self):
        self.getPostData()
        post1Report = PostReportPatientClass.setAnesthetic_complications_operationroom(self.post1_info)
        post2Report = PostReportPatientClass.setAnesthetic_complications_admitroom(self.post2_info)
        post3Report = PostReportPatientClass.setAnesthetic_complications_admitroom_2hrs(self.post3_info)
        post4Report = PostReportPatientClass.setAnesthetic_complications_admitroom_24hrs(self.post4_info)
        post5Report = PostReportPatientClass.setAnesthetic_complications_procedure(self.post5_info)
        post6Report = PostReportPatientClass.setAnesthetic_complications_admitroom_48hrs(self.post6_info)
        post7Report = PostReportPatientClass.setAnesthetic_complications_admitroom_7day(self.post7_info)
    ...
    def forDevIntra(self):
        intra = ['1234', '01/06/2017', '0001', '101', 'room1', 'Janet van Dyne', 'Wanda Maximoff',
